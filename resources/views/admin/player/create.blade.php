            ...
            <div class="card col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1"
                ...
                <div class="card-header">
                    <div class="card-title col-12">
                        ...
                        <a href="{{ auth()->user() && (int) auth()->user()->type === \App\Enums\UserType::Agent->value ? route('admin.agent.players.index') : route('admin.players.grouped') }}" class="btn btn-primary d-inline float-right">
                            <i class="fas fa-arrow-left mr-2"></i> Back
                        </a>
                    </div>
                </div>
                <form action="{{ route('admin.agent.players.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="user_name" value="{{ $playerName }}"
                                        readonly>
                                    @error('user_name')
                            ...
                            @if($currentType === \App\Enums\UserType::Owner)
                                <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1 ">
                                    <div class="form-group">
                                        <label>Assign Agent<span class="text-danger">*</span></label>
                                        <select class="form-control" name="agent_id" required>
                                            <option value="">Select Agent</option>
                                            @foreach($agents as $agent)
                                            <option value="{{ $agent->id }}" {{ old('agent_id', $selectedAgentId) == $agent->id ? 'selected' : '' }}>
                                                    {{ $agent->user_name }} &mdash; {{ $agent->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('agent_id')
                            ...
                            <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1 ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" name="amount" value="{{ old('amount', 0) }}">
                                </div>
