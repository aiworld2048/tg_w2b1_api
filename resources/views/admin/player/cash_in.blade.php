    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1" style="border-radius: 15px;" >
                ...
                <form action="{{ route('admin.agent.players.makeCashIn', $player->id) }}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-12 offset-lg-0 col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-10 offset-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="" value="{{$player->name}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Current Balance<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ number_format((float) $player->balance, 2) }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Funding Agent<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $fundingAgent->user_name }} - {{ $fundingAgent->name }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Amount<span class="text-danger">*</span></label>
                                    <span class="badge badge-success">Max:{{ number_format((float) $fundingAgent->balance, 2) }}</span>
